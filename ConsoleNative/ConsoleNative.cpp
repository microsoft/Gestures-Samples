...
// This function will be called upon gesture detection - it will emit the gesture name to the console w/ colors
...
{	
	...
	Console::WriteLine(L"Welcome to Microsoft Gestures Console ! press 'ctrl+c' to exit");
	...
	// This is the way for subscribing/regitering for events notifcation, kindly note the 'rotateTriggerEventScoper' retrun value, this is 
