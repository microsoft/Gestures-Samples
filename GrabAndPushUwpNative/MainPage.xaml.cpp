...
using namespace ImageScaleSampleUwpNative;
...
void MainPage::UpdateUi(const SmoothedPositionChangeEventArgs& args)
{
	...
	// Composition of the scaling followd by the translation
...
{
	/////////////////////////////////////////////////////////////////////////////////////////////////
	/// This sample demonstrates how to use/manipulate the hands skeletons stream, along w/ how    //
	//  to define "complex" gesture which triggers the consumption of the hands skeletons stream   //
	/////////////////////////////////////////////////////////////////////////////////////////////////
	...
	auto spreadForwardPose = HandPose::Make(L"Spread",
											...
											FingerPose::Make({ Finger::Thumb, Finger::Index, Finger::Middle, Finger::Ring, Finger::Pinky }, FingerFlexion::Open),
											FingerPose::Make({ Finger::Index, Finger::Middle, Finger::Ring, Finger::Pinky }, PoseDirection::Up));
	// ... define the second pose, ...
	auto fistForwardPose = HandPose::Make(L"Fist",
										  PalmPose::Make(AnyHandContext::Make(), PoseDirection::Forward),
										  FingerPose::Make({ Finger::Thumb, Finger::Index, Finger::Middle, Finger::Ring, Finger::Pinky }, FingerFlexion::Folded));
	...
	// Once the fist segment of the gesture is detected, we "enable"/subscribe for (on the UI thread) hands skeletons streaming
	...
	// The state machine of the grab register restored to its "Idle" state so its time to un-subscribe from the hand skeletons stream
